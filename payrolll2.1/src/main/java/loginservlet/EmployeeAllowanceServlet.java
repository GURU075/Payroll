 ...
 */
public class EmployeeAllowanceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeeAllowanceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        String StrQuery1="select * from empallowance where allowance_name='"+StrAllowance+"' and empid="+StrEmpid;
			...
			catch(Exception e)
			{
	     	...
	     	if(rs1.next())
	     	{
	     		response.sendRedirect("../payrolll2.0/EmployeeAllowance/AddAllowance.jsp");
	     	}
	     	else
	     	{
