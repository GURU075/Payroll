 ...
 */
public class EmployeeDedcutionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeeDedcutionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        String StrQuery1="select * from empdeduction where decuctionname='"+StrDeduction+"' and empid="+StrEmpid;
			...
			EmpDeductionDTO adto=new EmpDeductionDTO();
	     	...
	     	if(rs1.next())
	     	{
	     		response.sendRedirect("../payrolll2.0/EmployeeDeduction/AddDeduction.jsp");
	     	}
	     	else
	     	{
