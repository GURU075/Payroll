      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
		  ...
		  <li class="nav-item menu-items">
            <a class="nav-link" href="../Allowance/AllowanceMaintaniance.jsp">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../Deduction/DeductionMaintaniance.jsp">
              <span class="menu-icon">
			 ...
			 <li class="nav-item menu-items">
            <a class="nav-link" href="../Employee/EmployeeMaintainance.jsp">
              <span class="menu-icon">
			...
			<li class="nav-item menu-items">
            <a class="nav-link" href="../Designation/DesignationMaintanaince.jsp">
              <span class="menu-icon">
			...
			<li class="nav-item menu-items">
            <a class="nav-link" href="../Department/DepartmentMaintaniance.jsp">
              <span class="menu-icon">
			...
			<li class="nav-item menu-items">
            <a class="nav-link" href="../TotalWorkDays/TWDMaintanince.jsp">
              <span class="menu-icon">
                <i class="mdi mdi-security"></i>
              </span>
              <span class="menu-title">Total Work Days</span>
            </a>
            </li>
			
			<li class="nav-item menu-items">
            <a class="nav-link" href="../Bank/BankMaintaniance.jsp">
              <span class="menu-icon">
			...
			<li class="nav-item menu-items">
            <a class="nav-link" href="../Users/UserMaintanaince.jsp">
              <span class="menu-icon">
                <i class="mdi mdi-table-large"></i>
              </span>
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" aria-expanded="false" href="../Users/UserMaintanaince.jsp">+ Add User</a>
