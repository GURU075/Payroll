...
<% 
 ...
 try {
	// Object value1 = request.getAttribute("Username");
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="../LoginServletFinalStage" method = "get">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="txtUser" id="txtUser" value="<%=rs.getString(3)%>" placeholder="Username" required>
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="password" name="txtPwd" id="txtPwd" value="<%=rs.getString(4)%>" required>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
