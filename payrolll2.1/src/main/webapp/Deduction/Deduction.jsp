        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="get" action="../DeductionServlet">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Deduction ID</label>
                                    <input class="input--style-4" type="number" id="deduid" name="deduid">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Deduction Name</label>
                                    <input class="input--style-4" type="text" id="deduname" name="deduname">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" id= "deducomment" name="deducomment">
                                </div>
                            </div>
                        </div>
