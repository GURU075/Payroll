        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="get" action="../Deduction/DeductionMaintaniance.jsp" class="register-form" id="register-form">
                        <h2>View Data</h2>
                        <div class="form-row">
						...
						<div class="form-group">
                         ...
                         <div class="form-group">
                                <label for="name">Deduction Description : <%=dto.getdeductionDesc()%></label>
                            </div>
