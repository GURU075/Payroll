		...
		<div class="wrapper wrapper--w680">
			<div class="card card-4">
				<div class="card-body">
					...
					<form method="GET" action="../LeavesServlet">
							...
							<div class="col-2">
								<div class="input-group">
									<label class="label">Emp ID</label> <input
										class="input--style-4" type="text" name="emp_id" value="<%=id%>" readonly>
								</div>
							</div>
						</div>
						...
						<div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="leave_desc" id="leave_desc">
                                </div>
                            </div>
                        ...
                        <div class="p-t-15">
                            ...
                            <a href="../Leaves/LeaveMaintainance.jsp?empid=<%=id%>" class="btn btn--radius-2 btn--blue">Back</a>
                        </div>
