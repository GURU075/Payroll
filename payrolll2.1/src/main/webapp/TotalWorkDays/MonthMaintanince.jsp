	...
	<div class="content">
		...
		<div class="container">
			...
			<div class="table-responsive">
				...
				<table class="table table-striped custom-table">
					...
					<tbody>
						...
						try {
							...
							String strQuery = "select * from totalworkdays where year=" + request.getParameter("aid");
						...
						<tr scope="row">
							...
							<td><a href="EditTWD.jsp?aid=<%=rs.getInt(1)%>&month=<%=rs.getString(2)%>" class="more"> Edit</a></td>
							<td><a href="DeleteMonth.jsp?aid=<%=rs.getInt(1)%>&month=<%=rs.getString(2)%>" class="more"> Delete</a></td>
				...
				<form method="get"
					action="../TotalWorkDays/AddDays.jsp">
					<div class="p-t-15">
						<button class="btn btn--radius-2 btn--blue" type="submit">New
							Record</button>

						<a href="../TotalWorkDays/TWDMaintanince.jsp"
