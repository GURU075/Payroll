        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="get" action="../Designation/DesignationMaintanaince.jsp" class="register-form" id="register-form">
                        <h2>View Data</h2>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="name">Designation Id :  <%= dto.getDesignationId()%></label>
                            </div>
                            
                        </div>
						<div class="form-group">
                                <label for="name">Designation Name : <%= dto.getDesignationName()%></label>
                            </div>
                            
                         <div class="form-group">
                                <label for="name">Designation Description : <%= dto.getDesignationDesc()%></label>
                            </div>
