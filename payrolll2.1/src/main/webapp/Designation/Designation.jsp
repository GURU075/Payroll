        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="get" action="../DesignationServlet">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Designation ID</label>
                                    <input class="input--style-4" type="number" id="desiid" name="desiid">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Designation Name</label>
                                    <input class="input--style-4" type="text" id="desiname" name="desiname">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" id= "desicomment" name="desicomment">
                                </div>
                            </div>
                        </div>
