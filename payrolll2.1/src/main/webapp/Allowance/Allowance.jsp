        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="get" action="../AllowanceServlet">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Allowance ID</label>
                                    <input class="input--style-4" type="number" id="allowanceId" name="allowanceId">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Allowance Name</label>
                                    <input class="input--style-4" type="text" id="allowanceName" name="allowanceName">
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" id= "allowanceDesc" name="allowanceDesc">
                                </div>
                            </div>
                        </div>
